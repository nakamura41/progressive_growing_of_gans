...
desc += '-anime-gan';           dataset = EasyDict(tfrecord_dir='anime-gan');      train.mirror_augment = True
...
desc += '-fp16'; G.dtype = 'float16'; D.dtype = 'float16'; G.pixelnorm_epsilon=1e-4; G_opt.use_loss_scaling = True; D_opt.use_loss_scaling = True; sched.max_minibatch_per_gpu = {256: 16, 512: 8, 1024: 4}
